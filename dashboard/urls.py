...
from .views import DashboardMetricsView, AdminCausesListView, AdminPaymentsListView, AdminDonationsListView, \
    RefreshReportView, AdminUserListView, AdminWithdrawalRequestsListView
...
urlpatterns = [
    ...
    path('withdrawals/', AdminWithdrawalRequestsListView.as_view(), name='admin_withdrawals_requests_list'),
