  ...
  return (
    <div className={styles.container}>
      <aside className={styles.sidebar}>
        <a href="#" onClick={() => handleIconClick('Menu')} className={styles.menuIcon}>
        ...
        <a href="#" onClick={() => handleIconClick('Dashboard')} className={styles.icon}>
          <svg width="20" height="20" viewBox="0 0 24 24" fill="#666">
            <rect width="18" height="18" x="3" y="3" rx="2" />
          </svg>
        </a>
        <a href="#" onClick={() => handleIconClick('Products')} className={styles.icon}>
          <svg width="20" height="20" viewBox="0 0 24 24" fill="#666">
        ...
        <a href="#" onClick={() => handleIconClick('Inbox')} className={styles.icon}>
          <svg width="20" height="20" viewBox="0 0 24 24" fill="#666">
            <path d="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z" />
          </svg>
        </a>
        <a href="#" onClick={() => handleIconClick('Order Lists')} className={styles.icon}>
          <svg width="20" height="20" viewBox="0 0 24 24" fill="#666">
            <path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-2 10H7v-2h10v2zm0-4H7V6h10v2z" />
          </svg>
        </a>
        <a href="#" onClick={() => handleIconClick('Product Stock')} className={styles.icon}>
          <svg width="20" height="20" viewBox="0 0 24 24" fill="#666">
        ...
        <a href="#" onClick={() => handleIconClick('TO - DO')} className={styles.icon}>
          <svg width="20" height="20" viewBox="0 0 24 24" fill="#666">
        ...
        <a href="#" onClick={() => handleIconClick('Contact')} className={styles.icon}>
          <svg width="20" height="20" viewBox="0 0 24 24" fill="#666">
            <path d="M20 2H4c-1.1 0-2 .9-2 2v18l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm-2 10H6v-2h12v2zm0-3H6V7h12v2zm0-3H6V4h12v2z" />
          </svg>
        </a>
        <a href="#" onClick={() => handleIconClick('Invoice')} className={styles.icon}>
          <svg width="20" height="20" viewBox="0 0 24 24" fill="#666">
            <path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-2 10H7v-2h10v2zm0-4H7V6h10v2z" />
          </svg>
        </a>
