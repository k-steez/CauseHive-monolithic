...
from .views import (register_user, LoginView, LogoutView, request_password_reset, reset_password_confirm,
                    UserProfileDetailView, UserAccountDeleteView, UserDetailView)
...
urlpatterns = [
    ...
    path('admins/<uuid:id>/', UserDetailView.as_view(), name='user_detail'),
